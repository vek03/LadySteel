                        ...
                        @endif
                            <div class="font-semibold grid grid-cols-2 text-2xl text-red-500 w-full px-5 py-2">
                                <a href="{{ route('supervisor.editar-atendente',  $attendant->id) }}" class="flex items-end justify-start cursor-pointer">
                                    ...
                                    <p class="invisible sm:visible">&nbsp;&nbsp;Editar</p>
                                </a>
                    ...
                    <div class="px-6 py-10">
                        <div class="grid grid-rows-8 gap-4 justify-center">
                                <ul class="grid w-full gap-6 md:grid-cols-4 grid-col-1">     
                                    <li>
                                        <input type="radio" id="one" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-one.png') checked @endif type="radio" name="img" value="img/avatares/avatar-one.png">
                                    ...
                                    <li>
                                        <input type="radio" id="two" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-two.png') checked @endif type="radio" name="img" value="img/avatares/avatar-two.png">
                                    ...
                                    <li>
                                        <input type="radio" id="three" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-three.png') checked @endif type="radio" name="img" value="img/avatares/avatar-three.png">
                                    ...
                                    <li>
                                        <input type="radio" id="four" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-four.png') checked @endif type="radio" name="img" value="img/avatares/avatar-four.png">
                                    ...
                                    <li>
                                        <input type="radio" id="nine" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-nine.png') checked @endif type="radio" name="img" value="img/avatares/avatar-nine.png">
                                        <label for="nine" class="inline-flex items-center justify-between rounded-full border-4 w-full border-rose-400 hover:border-red-500 cursor-pointer  peer-checked:border-red-500">                           
                                            <div class="block">
                                                <img class="md:w-28 mx-auto rounded-full w-28  border-4" src="{{ asset('img/avatares/avatar-nine.png') }}">        
                                            </div>
                                        </label>
                                    </li>
                                    <li>
                                        <input type="radio" id="ten" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-ten.png') checked @endif type="radio" name="img" value="img/avatares/avatar-ten.png">
                                        <label for="ten" class="inline-flex items-center justify-between rounded-full border-4 w-full border-rose-400 hover:border-red-500 cursor-pointer  peer-checked:border-red-500">                           
                                            <div class="block">
                                                <img class="md:w-28 mx-auto rounded-full w-28  border-4" src="{{ asset('img/avatares/avatar-ten.png') }}">        
                                            </div>
                                        </label>
                                    </li>
                                    <li>
                                        <input type="radio" id="eleven" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-eleven.png') checked @endif type="radio" name="img" value="img/avatares/avatar-eleven.png">
                                        <label for="eleven" class="inline-flex items-center justify-between rounded-full border-4 w-full border-rose-400 hover:border-red-500 cursor-pointer peer-checked:border-red-500">                           
                                            <div class="block">
                                                <img class="md:w-28 mx-auto rounded-full w-28  border-4" src="{{ asset('img/avatares/avatar-eleven.png') }}">        
                                            </div>
                                        </label>
                                    </li>
                                    <li>
                                        <input type="radio" id="twelve" class="hidden peer" @if($attendant->img === 'img/avatares/avatar-twelve.png') checked @endif type="radio" name="img" value="img/avatares/avatar-twelve.png">
                                        <label for="twelve" class="inline-flex items-center justify-between rounded-full border-4 w-full border-rose-400 hover:border-red-500 cursor-pointer peer-checked:border-red-500">                           
                                            <div class="block">
                                                <img class="md:w-28 mx-auto rounded-full w-28  border-4" src="{{ asset('img/avatares/avatar-twelve.png') }}">        
                                            </div>
                                        </label>
                                    </li>  
                                </ul>      
